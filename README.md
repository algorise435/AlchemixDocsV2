...
1. **Deposit to Earn & Borrow**  
   Deposit your collateral into your preferred yield strategy to start earning interest and unlock borrowing. Use your deposit to borrow and receive alAssets while your collateral continues to earn.
2. **Swap alAssets**  
   Swap the alAssets to any other token via a DEX or DEX aggregator to access the value of your loan. alAssets can also be used directly on some DeFi protocols.
3. **Wait, Withdraw, Borrow, Repay, or Self-Liquidate**  
   Your chosen yield strategy earns interest on the full initial deposit. As yield accrues, your share automatically repays your debt over time. Manage your loan as needed with the flexibility to withdraw principal, borrow more, repay, or self-liquidate at any time.
